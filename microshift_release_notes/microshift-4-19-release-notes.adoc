...
With this release, {microshift-short} adds the Telemeter API. Lightweight attributes can be sent from a connected clusters to Red{nbsp}Hat to monitor the health of the cluster, assist with support, and improve your customer experience. To opt-in to Telemetry, see
