...
//is this method the actual happy path for customers?
...
====
//for SOME? which ones? do we document this in a route config doc?
...
//ok, if it kinda stinks to do it this way, why do we even list it? is there a scenario where this method is required?
