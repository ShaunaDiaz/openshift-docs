...
{prodname} {version} includes enhanced Observability documentation, including configuring access logs, tracing, and request correlation. For more information, see xref:../observe_troubleshoot/observability.adoc#rhcl-observability[Red{nbsp}Hat Connectivity Link observability].
