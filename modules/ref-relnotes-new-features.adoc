...
/{prodname} {version} provides integration with https://coredns.io/[CoreDNS] for on-premise DNS as a Generally Available feature. For more information, see xref:../deployment/deployment.adpc#proc-configure-onprem-dns-coredns_rhcl-config-deploy-gateway-policies[Configure on-premise DNS with CoreDNS].
