...
----
$ oc apply -f _<bob-key.yaml>_
----
+
Replace `_<bob-key.yaml>_` with the filename you used.
+
[source,terminal,subs="+quotes"]
----
$ oc apply -f _<alice-key.yaml>_
----
+
Replace `_<alice-key.yaml>_` with the filename you used.
