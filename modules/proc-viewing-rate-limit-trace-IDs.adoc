...
[role="_abstract"]
When using the Limitador component of {prodname} for rate limiting, you can enable request logging with trace IDs to get more information about requests. To do this, you must increase the log level.
...
. Set the verbosity to `3` or higher in your `Limitador` custom resource as follows:
+
