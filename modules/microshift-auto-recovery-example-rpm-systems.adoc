...
= Using auto-recovery in RPM systems
...
As a use case, consider the following example situation in which you want to automate the auto-recovery process for RPM systems that use the systemd service.
