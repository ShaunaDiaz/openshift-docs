...
|`tls`
|`list`
|Defines the transport later protocol (TLS) used and the cipher suites allowed. Provides security for exposed {microshift-short} the default router and the API server internal control plane endpoints.
